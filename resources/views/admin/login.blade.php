                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="{{ route('login') }}" autocomplete="on" method="post" role="form">
                                <h3 class="black_bg">
                                    <img src="{{ asset('assets/img/528logo.png') }}" alt="528logo">
                                    <br>Log in</h3>
                                    <!-- CSRF Token -->
                        ...
                        <div id="register" class="animate form">
                            <form action="{{ route('register') }}" autocomplete="on" method="post" role="form">
                                <h3 class="black_bg">
                                    <img src="{{ asset('assets/img/528logo.png') }}" alt="josh logo">
                                    <br>Sign Up</h3>
                                    <!-- CSRF Token -->
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                    ...
                                    <div class="form-group {{ $errors->first('first_name', 'has-error') }}">
                                        ...
                                        <input id="first_name" name="first_name" required type="text" placeholder="First-name" value="" />
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group {{ $errors->first('phone', 'has-error') }}">
                                        <label style="margin-bottom:0px;" for="phone" class="youmail">
                                            <i class="livicon" data-name="phone" data-size="16" data-loop="true" data-c="#3c8dbc" data-hc="#3c8dbc"></i>
                                            Phone
                                        </label>
                                        <input id="phone" name="phone" required type="text" placeholder="09--------" value="" />
                                        <div class="col-sm-12">
                        ...
                        <div id="forgot" class="animate form">
                            <form action="{{ route('forgot-password') }}" autocomplete="on" method="post" role="form">
                                <h3 class="black_bg">
                                    <img src="{{ asset('assets/img/528logo.png') }}" alt="josh logo">Password
                                </h3>
                                <p>
